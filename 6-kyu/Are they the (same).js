function comp(arr1, arr2) {
  ...
  arr1Square = arr1.map((a) => a * a).sort((d, e) => d - e);
  let arr2Sort = arr2;
  switch (arr2) {
    case null:
      return false;
  }
  arr2Sort = arr2.slice().sort((a, b) => a - b);
  for (let i = 0; i < arr1Square.length; ++i)
    if (arr1Square[i] !== arr2Sort[i]) return false;
  return arr2Sort !== null;
}
